...
(function () {
  ...
  // resolve logo relative to this script, so it works at any page depth
  var LOGO = new URL('assets/musubi-logo.png', (document.currentScript || {}).src || location.href).href;
  ...
  function mount() {
    ...
    g.innerHTML =
      '<div style="background:#fff;border-radius:18px;padding:38px 34px 30px;width:min(360px,86vw);box-shadow:0 24px 60px rgba(0,0,0,.4);text-align:center">' +
        '<img src="' + LOGO + '" alt="Musubi" style="height:52px;display:block;margin:0 auto 14px">' +
        '<div style="font-size:12.5px;color:#8b8578;margin:6px 0 22px">デモ閲覧にはパスワードが必要です</div>' +
